...
def main():
    ...
    para(doc, "构建8个离线统计特征：句长均匀度、段落均匀度、套话密度（“综上所述、本研究、值得注意的是”等）、连接词密度、"
              "低具体性（数字密度取补）、重复率，以及两个“相对附件1参照均值偏离”特征——逻辑异常度（连接词密度偏离附件1 30篇均值）、术语偏离度（术语丰富度偏离附件1均值）。"
              "加权（0.15/0.12/0.15/0.08/0.15/0.12/0.11/0.12）合成AI辅助指数，映射为低/中/高三档。"
